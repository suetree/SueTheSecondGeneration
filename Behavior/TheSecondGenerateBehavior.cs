...
namespace SueTheSecondGeneration.Behavior
{
    class TheSecondGenerateBehavior : CampaignBehaviorBase
    {
        ...
        {
            dataStore.SyncData<bool>("IsGenerated", ref this._isGenerated);
        }
        ...
        private void OnAffirmative()
        {
            ...
            TheSecondGenerationState state = Game.Current.GameStateManager.CreateState<TheSecondGenerationState>();
