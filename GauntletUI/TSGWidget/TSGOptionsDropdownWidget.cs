...
namespace SueTheSecondGeneration.GauntletUI.TSGWidget
{
    class TSGOptionsDropdownWidget : Widget
	{
		...
		public TSGOptionsDropdownWidget(UIContext context) : base(context)
		{
