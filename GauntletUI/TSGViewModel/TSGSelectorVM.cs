...
{
    class TSGSelectorVM<T> : ViewModel where T : SelectorItemVM
    {

		private Action<TSGSelectorVM<T>> _onChange;
		...
		public TSGSelectorVM( Action<TSGSelectorVM<T>> onChange)
		{
		...
		public TSGSelectorVM(IEnumerable<string> list, List<int> selectIndexs, Action<TSGSelectorVM<T>> onChange, bool isMutipleSelectMode)
		{
		...
		public TSGSelectorVM(IEnumerable<TextObject> list, List<int> selectIndexs , Action<TSGSelectorVM<T>> onChange, bool isMutipleSelectMode)
		{
			this.IsMutipleSelectMode = isMutipleSelectMode;
			this.ItemList = new MBBindingList<T>();
			this.Refresh(list, selectIndexs, onChange);
		...
		public void Refresh(IEnumerable<string> list, List<int> selectedIndexs, Action<TSGSelectorVM<T>> onChange)
		{
			this.ItemList.Clear();
		...
		public void Refresh(IEnumerable<TextObject> list, List<int> selectedIndexs, Action<TSGSelectorVM<T>> onChange)
		{
			this.ItemList.Clear();
			Action<T> test = OnSelectorItemClick;
		...
		public void Refresh(List<int> selectedIndexs, Action<TSGSelectorVM<T>> onChange)
        {
		...
		public void SetOnChangeAction(Action<TSGSelectorVM<T>> onChange)
		{
			this._onChange = onChange;
		}
